	...
	<div class="column">
		<div class="ui segment">
			...
			<div class="ui basic center aligned segment">
				<a target="_blank" class="webicon github" href="https://github.com/ProjectCleverWeb">Github</a>
				<a target="_blank" class="webicon coderwall" href="https://coderwall.com/projectcleverweb">Coderwall</a>
				<a target="_blank" class="webicon stackoverflow" href="http://stackoverflow.com/users/3511423/nick-j">Stack Overflow</a>
				<a target="_blank" class="webicon wordpress" href="http://profiles.wordpress.org/njordon">Wordpress</a>
			</div>
		</div>
	</div>
	<div class="column">
